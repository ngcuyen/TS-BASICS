...
const complete = document.querySelector("#taskDone > #listDone");
    ...
    btnOK.addEventListener("click", function (event) {
        if (taskInput.value === '') {
            ...
            trashElement.addEventListener("click", () => {
                var _a;
                (_a = trashElement.parentElement) === null || _a === void 0 ? void 0 : _a.remove();
            });
            editElement.addEventListener("click", () => {
                var _a;
                const currentContent = (_a = newElement.textContent) !== null && _a !== void 0 ? _a : "";
...
function logMovies() {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const response = yield fetch("https://shop.cyberlearn.vn/api/Product");
